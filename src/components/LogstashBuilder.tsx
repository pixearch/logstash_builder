...
const COMMON_DEFS: Record<string, string> = {
  add_field: "{}",
  codec: '"plain"',
  enable_metric: "true",
  id: '"my_id"',
...
const PLUGIN_DEFINITIONS: any = {
  input: {
    azure_event_hubs: { checkpoint_interval: "5", config_mode: '"basic"', consumer_group: '"$Default"', decorate_events: "false", event_hub_connection: '""', event_hub_connections: "[]", event_hubs: "[]", initial_position: '"beginning"', initial_position_look_back: "86400", max_batch_size: "125", storage_connection: '""', storage_container: '""', threads: "16" },
    beats: { add_hostname: "false", client_inactivity_timeout: "60", ecs_compatibility: '"disabled"', enrich: "[]", event_loop_threads: "4", executor_threads: "4", host: '"0.0.0.0"', include_codec_tag: "true", port: "5044", ssl_certificate: '""', ssl_certificate_authorities: "[]", ssl_cipher_suites: "[]", ssl_client_authentication: '"none"', ssl_enabled: "false", ssl_handshake_timeout: "10000", ssl_key: '""', ssl_key_passphrase: '""', ssl_supported_protocols: "[]" },
    cloudwatch: { access_key_id: '""', aws_credentials_file: '""', combined: "false", endpoint: '""', filters: "{}", interval: "900", metrics: '["CPUUtilization"]', namespace: '"AWS/EC2"', period: "300", proxy_uri: '""', region: '"us-east-1"', role_arn: '""', role_session_name: '""', secret_access_key: '""', session_token: '""', statistics: '["Average"]', use_aws_bundled_ca: "false", use_ssl: "true", web_identity_token_file: '""' },
    couchdb_changes: { always_reconnect: "true", ca_file: '""', db: '"logs"', heartbeat: "true", host: '"localhost"', ignore_attachments: "true", initial_sequence: "0", keep_id: "false", keep_revision: "false", password: '""', port: "5984", reconnect_delay: "10", secure: "false", sequence_path: '""', timeout: "10000", username: '""' },
    dead_letter_queue: { clean_consumed: "true", commit_offsets: "true", path: '"/var/lib/logstash/dead_letter_queue"', pipeline_id: '"main"', sincedb_path: '""', start_timestamp: '"2024-01-01T00:00:00"' },
    elastic_agent: { add_hostname: "false", client_inactivity_timeout: "60", ecs_compatibility: '"v1"', enrich: "[]", event_loop_threads: "4", executor_threads: "4", host: '"0.0.0.0"', include_codec_tag: "true", port: "5044", ssl_certificate: '""', ssl_certificate_authorities: "[]", ssl_cipher_suites: "[]", ssl_client_authentication: '"none"', ssl_enabled: "true", ssl_handshake_timeout: "10000", ssl_key: '""', ssl_key_passphrase: '""', ssl_supported_protocols: "[]" },
    elastic_serverless_forwarder: { auth_basic_password: '""', auth_basic_username: '""', host: '"0.0.0.0"', port: "5044", ssl_certificate: '""', ssl_certificate_authorities: "[]", ssl_cipher_suites: "[]", ssl_client_authentication: '"none"', ssl_enabled: "true", ssl_handshake_timeout: "10000", ssl_key: '""', ssl_key_passphrase: '""', ssl_supported_protocols: "[]", ssl_verification_mode: '"full"' },
    elasticsearch: { api_key: '""', ca_trusted_fingerprint: '""', cloud_auth: '""', cloud_id: '""', connect_timeout_seconds: "10", custom_headers: "{}", docinfo: "false", docinfo_fields: '["_index", "_id", "_type"]', docinfo_target: '"@metadata"', ecs_compatibility: '"disabled"', hosts: '["localhost:9200"]', index: '"logstash-*"', last_run_metadata_path: '""', password: '""', proxy: '""', query: '{ "query": { "match_all": {} } }', query_type: '"scroll"', request_timeout_seconds: "60", response_type: '"java"', retries: "3", schedule: '""', schedule_overlap: "false", scroll: '"1m"', search_api: '"search"', size: "1000", slices: "1", socket_timeout_seconds: "60", ssl_certificate: '""', ssl_certificate_authorities: "[]", ssl_cipher_suites: "[]", ssl_enabled: "false", ssl_key: '""', ssl_keystore_password: '""', ssl_keystore_path: '""', ssl_keystore_type: '""', ssl_supported_protocols: "[]", ssl_truststore_password: '""', ssl_truststore_path: '""', ssl_truststore_type: '""', ssl_verification_mode: '"full"', target: '""', tracking_field: '"@timestamp"', tracking_field_seed: "0", user: '""' },
    exec: { command: "\"echo 'hello'\"", ecs_compatibility: '"disabled"', interval: "60", schedule: '""' },
    file: { check_archive_validity: "false", close_older: '"1 hour"', delimiter: '"\\n"', discover_interval: "15", ecs_compatibility: '"disabled"', exclude: "[]", exit_after_read: "false", file_chunk_count: "4611686018427387903", file_chunk_size: "32768", file_completed_action: '"delete"', file_completed_log_path: '""', file_sort_by: '"last_modified"', file_sort_direction: '"desc"', ignore_older: "86400", max_open_files: "4095", mode: '"tail"', path: '["/var/log/*.log"]', sincedb_clean_after: '"2 weeks"', sincedb_path: '""', sincedb_write_interval: "15", start_position: '"end"', stat_interval: "1" },
    ganglia: { host: '"0.0.0.0"', port: "8649" },
    gelf: { host: '"0.0.0.0"', port: "12201", port_tcp: "12201", port_udp: "12201", remap: "true", strip_leading_underscore: "true", use_tcp: "false", use_udp: "true" },
    generator: { count: "0", ecs_compatibility: '"disabled"', lines: "[]", message: '"Hello world!"', threads: "1" },
    github: { drop_invalid: "false", ip: '"0.0.0.0"', port: "8080", secret_token: '""' },
    google_cloud_storage: { bucket_id: '""', delete: "false", file_exclude: '""', file_matches: '".*"', interval: "60", json_key_file: '""', metadata_key: '"metadata"', processed_db_path: '""', unpack_gzip: "true" },
    google_pubsub: { create_subscription: "true", include_metadata: "false", json_key_file: '""', max_messages: "5", project_id: '""', subscription: '""', topic: '""' },
    graphite: { "data_timeout (DEPRECATED)": '""', host: '"0.0.0.0"', mode: '"server"', port: "2003", proxy_protocol: "false", "ssl_cacert (DEPRECATED)": '""', ssl_cert: '""', ssl_enable: "false", ssl_extra_chain_certs: "[]", ssl_key: '""', ssl_key_passphrase: '""', ssl_verify: "false" },
    heartbeat: { count: "-1", ecs_compatibility: '"disabled"', interval: "60", message: '"ok"', sequence: '"default"', threads: "1" },
    http: { additional_codecs: "{}", ecs_compatibility: '"disabled"', host: '"0.0.0.0"', max_content_length: "104857600", max_pending_requests: "200", password: '""', port: "8080", remote_host_target_field: '"host"', request_headers_target_field: '"headers"', response_code: "200", response_headers: "{}", ssl_certificate: '""', ssl_certificate_authorities: "[]", ssl_cipher_suites: "[]", ssl_client_authentication: '"none"', ssl_enabled: "false", ssl_handshake_timeout: "10000", ssl_key: '""', ssl_keystore_password: '""', ssl_keystore_path: '""', ssl_keystore_type: '""', ssl_supported_protocols: "[]", ssl_truststore_password: '""', ssl_truststore_path: '""', ssl_truststore_type: '""', threads: "4", user: '""' },
    http_poller: { automatic_retries: "1", connect_timeout: "10", cookies: "true", ecs_compatibility: '"disabled"', follow_redirects: "true", keepalive: "true", metadata_target: '"@metadata"', password: '""', pool_max: "50", pool_max_per_route: "25", proxy: '""', request_timeout: "60", retry_non_idempotent: "false", schedule: "{}", socket_timeout: "10", ssl_certificate: '""', ssl_certificate_authorities: "[]", ssl_cipher_suites: "[]", ssl_enabled: "false", ssl_key: '""', ssl_keystore_password: '""', ssl_keystore_path: '""', ssl_keystore_type: '""', ssl_supported_protocols: "[]", ssl_truststore_password: '""', ssl_truststore_path: '""', ssl_truststore_type: '""', ssl_verification_mode: '"full"', target: '""', urls: "{}", user: '""', validate_after_inactivity: "2000" },
    imap: { attachments_target: '""', check_interval: "300", content_type: '"text/plain"', delete: "false", ecs_compatibility: '"disabled"', expunge: "false", fetch_count: "50", folder: '"INBOX"', headers_target: '""', host: '""', lowercase_headers: "true", password: '""', port: "143", save_attachments: "false", secure: "true", sincedb_path: '""', strip_attachments: "false", uid_tracking: "false", user: '""', verify_cert: "true" },
    irc: { catch_all: "false", channels: "[]", get_stats: "true", host: '""', nick: '"logstash"', password: '""', port: "6667", real: '"logstash"', secure: "false", stats_interval: "5", user: '"logstash"' },
    java_generator: { count: "0", eps: "0", lines: "[]", message: '"Hello world!"', threads: "1" },
    java_stdin: {},
    jdbc: { clean_run: "false", columns_charset: "{}", connection_retry_attempts: "1", connection_retry_attempts_wait_time: "0.5", interval: '""', jdbc_connection_string: '""', jdbc_default_timezone: '"UTC"', jdbc_driver_class: '""', jdbc_driver_library: '""', jdbc_fetch_size: "null", jdbc_page_size: "100000", jdbc_paging_enabled: "false", jdbc_paging_mode: '"auto"', jdbc_password: '""', jdbc_password_filepath: '""', jdbc_pool_timeout: "5", jdbc_user: '""', jdbc_validate_connection: "false", jdbc_validation_timeout: "3600", last_run_metadata_path: '""', lowercase_column_names: "true", parameters: "{}", period: '""', plugin_timezone: '"utc"', prepared_statement_bind_values: "[]", prepared_statement_name: '""', record_last_run: "true", schedule: '""', sequel_opts: "{}", sql_log_level: '"info"', statement: '""', statement_filepath: '""', statement_retry_attempts: "-1", statement_retry_attempts_wait_time: "100", target: '""', tracking_column: '""', tracking_column_type: '"numeric"', use_column_value: "false", use_prepared_statements: "false" },
    jms: { broker_url: '""', destination: '""', durable_subscriber: "false", durable_subscriber_client_id: '""', durable_subscriber_name: '""', ecs_compatibility: '"disabled"', factory: '""', factory_settings: "{}", headers_target: '""', include_body: "true", include_header: "true", include_headers: "true", include_properties: "true", interval: "10", jndi_context: "{}", jndi_name: '""', keystore: '""', keystore_password: '""', oracle_aq_buffered_messages: "false", password: '""', properties_target: '""', pub_sub: "false", require_jars: "[]", runner: '"consumer"', selector: '""', skip_headers: "[]", skip_properties: "[]", system_properties: "{}", target: '""', threads: "1", timeout: "-1", truststore: '""', truststore_password: '""', use_jms_timestamp: "false", username: '""', yaml_file: '""', yaml_section: '""' },
    jmx: { nb_thread: "4", path: '""', polling_frequency: "60" },
    kafka: { auto_commit_interval_ms: "5000", auto_create_topics: "true", auto_offset_reset: '"latest"', bootstrap_servers: '"localhost:9092"', check_crcs: "true", client_dns_lookup: '"default"', client_id: '""', client_rack: '""', connections_max_idle_ms: "540000", consumer_threads: "1", decorate_events: "false", enable_auto_commit: "true", exclude_internal_topics: "true", fetch_max_bytes: "52428800", fetch_max_wait_ms: "500", fetch_min_bytes: "1", group_id: '"logstash"', group_instance_id: '""', group_protocol: '"classic"', heartbeat_interval_ms: "3000", isolation_level: '"read_uncommitted"', jaas_path: '""', kerberos_config: '""', key_deserializer_class: '"org.apache.kafka.common.serialization.StringDeserializer"', max_partition_fetch_bytes: "1048576", max_poll_interval_ms: "300000", max_poll_records: "500", metadata_max_age_ms: "300000", partition_assignment_strategy: '["org.apache.kafka.clients.consumer.RangeAssignor"]', poll_timeout_ms: "100", receive_buffer_bytes: "65536", reconnect_backoff_max_ms: "1000", reconnect_backoff_ms: "50", request_timeout_ms: "30000", retry_backoff_ms: "100", sasl_client_callback_handler_class: '""', sasl_iam_jar_paths: "[]", sasl_jaas_config: '""', sasl_kerberos_service_name: '""', sasl_login_callback_handler_class: '""', sasl_login_connect_timeout_ms: "10000", sasl_login_read_timeout_ms: "10000", sasl_login_retry_backoff_max_ms: "1000", sasl_login_retry_backoff_ms: "100", sasl_mechanism: '"GSSAPI"', sasl_oauthbearer_scope_claim_name: '"scope"', sasl_oauthbearer_token_endpoint_url: '""', schema_registry_key: '""', schema_registry_proxy: '""', schema_registry_secret: '""', schema_registry_ssl_keystore_location: '""', schema_registry_ssl_keystore_password: '""', schema_registry_ssl_keystore_type: '""', schema_registry_ssl_truststore_location: '""', schema_registry_ssl_truststore_password: '""', schema_registry_ssl_truststore_type: '""', schema_registry_url: '""', schema_registry_validation: "false", security_protocol: '"PLAINTEXT"', send_buffer_bytes: "131072", session_timeout_ms: "45000", ssl_endpoint_identification_algorithm: '"https"', ssl_key_password: '""', ssl_keystore_location: '""', ssl_keystore_password: '""', ssl_keystore_type: '""', ssl_truststore_location: '""', ssl_truststore_password: '""', ssl_truststore_type: '""', topics: '["logstash"]', topics_pattern: '""', value_deserializer_class: '"org.apache.kafka.common.serialization.StringDeserializer"' },
    kinesis: { additional_settings: '""', application_name: '"logstash_kinesis_ingress"', checkpoint_interval_seconds: "60", http_proxy: '""', initial_position_in_stream: '"TRIM_HORIZON"', kinesis_stream_name: '""', metrics: '"null"', non_proxy_hosts: '""', profile: '""', region: '"us-east-1"', role_arn: '""', role_session_name: '""' },
    logstash: { host: '"0.0.0.0"', password: '""', port: "9800", ssl_certificate: '""', ssl_certificate_authorities: "[]", ssl_client_authentication: '"none"', ssl_enabled: "true", ssl_key: '""', ssl_key_passphrase: '""', ssl_keystore_password: '""', ssl_keystore_path: '""', username: '"logstash_user"' },
    log4j: { host: '"0.0.0.0"', mode: '"server"', port: "4560", proxy_protocol: "false" },
    lumberjack: { congestion_threshold: "5", host: '"0.0.0.0"', port: "5000", ssl_certificate: '""', ssl_key: '""', ssl_key_passphrase: '""' },
    meetup: { eventstatus: '"upcoming"', groupid: '""', interval: "3600", meetupkey: '""', text: '""', urlname: '""', venueid: '""' },
    pipe: { command: '""', ecs_compatibility: '"disabled"' },
    puppet_facter: { environment: '""', host: '"0.0.0.0"', interval: "600", port: "8140", private_key: '""', public_key: '""', ssl: "true" },
    rabbitmq: { ack: "true", arguments: "{}", auto_delete: "false", automatic_recovery: "true", connect_retry_interval: "60", connection_timeout: "1000", durable: "true", exchange: '"logstash"', exchange_type: '"direct"', exclusive: "false", heartbeat: "0", host: '"localhost"', key: '"logstash"', "Metadata mapping": "{}", metadata_enabled: "false", passive: "false", password: '"guest"', port: "5672", prefetch_count: "256", queue: '""', ssl: "false", ssl_certificate_password: '""', ssl_certificate_path: '""', ssl_version: '"TLSv1.2"', subscription_retry_interval_seconds: "5", threads: "1", user: '"guest"', vhost: '"/"' },
    redis: { batch: "false", batch_events: "50", batch_timeout: "5", congestion_interval: "1", congestion_threshold: "5", data_type: '"list"', db: "0", host: '["127.0.0.1"]', key: '""', password: '""', port: "6379", reconnect_interval: "1", shuffle_hosts: "true", ssl: "false", ssl_certificate: '""', ssl_certificate_authorities: "[]", ssl_cipher_suites: "[]", ssl_enabled: "false", ssl_key: '""', ssl_key_passphrase: '""', ssl_supported_protocols: "[]", ssl_verification_mode: '"full"', timeout: "5" },
    relp: { host: '"0.0.0.0"', port: "514", ssl_cacert: '""', ssl_cert: '""', ssl_enable: "false", ssl_key: '""', ssl_key_passphrase: '""', ssl_verify: "true" },
    rss: { interval: "120", url: '""' },
    s3: { access_key_id: '""', additional_settings: "{}", aws_credentials_file: '""', backup_add_prefix: '""', backup_to_bucket: '""', backup_to_dir: '""', bucket: '""', delete: "false", ecs_compatibility: '"disabled"', endpoint: '""', exclude_pattern: '""', gzip_pattern: '""', include_object_properties: "false", interval: "60", prefix: '""', proxy_uri: '""', region: '"us-east-1"', role_arn: '""', role_session_name: '""', secret_access_key: '""', session_token: '""', sincedb_path: '""', temporary_directory: '"/tmp/logstash"', use_aws_bundled_ca: "false", watch_for_new_files: "true", web_identity_token_file: '""' },
    "s3-sns-sqs": { access_key_id: '""', region: '"us-east-1"', s3_bucket: '""', secret_access_key: '""', sqs_queue: '""' },
    salesforce: { api_version: '"39.0"', changed_data_filter: '"LastModifiedDate > {latest}"', client_id: '""', client_secret: '""', interval: "60", password: '""', security_token: '""', sfdc_fields: "[]", sfdc_filters: "[]", sfdc_instance_url: '""', sfdc_object_name: '""', timeout: "10000", to_underscores: "false", tracking_field: '""', tracking_field_value_file: '""', use_test_sandbox: "false", use_tooling_api: "false", username: '""' },
    snmp: { auth_pass: '""', auth_protocol: '"md5"', ecs_compatibility: '"disabled"', get: "[]", hosts: "[]", interval: "30", local_engine_id: '""', mib_paths: "[]", oid_map_field_values: "true", oid_mapping_format: '"ruby_snmp"', oid_path_length: "0", oid_root_skip: "0", poll_hosts_timeout: "2", priv_pass: '""', priv_protocol: '"des"', security_level: '"authPriv"', security_name: '""', tables: "[]", target: '""', threads: "1", use_provided_mibs: "true", walk: "[]" },
    snmptrap: { auth_pass: '""', auth_protocol: '"md5"', community: '"public"', ecs_compatibility: '"disabled"', host: '"0.0.0.0"', mib_paths: "[]", oid_map_field_values: "true", oid_mapping_format: '"ruby_snmp"', oid_path_length: "0", oid_root_skip: "0", port: "1062", priv_pass: '""', priv_protocol: '"des"', security_level: '"authPriv"', security_name: '""', supported_transports: '["udp", "tcp"]', supported_versions: '["1", "2c"]', target: '""', threads: "1", use_provided_mibs: "true", yamlmibdir: '""' },
    sqlite: { batch: "5", exclude_tables: "[]", path: '""' },
    sqs: { access_key_id: '""', additional_settings: "{}", aws_credentials_file: '""', endpoint: '""', id_field: '""', md5_field: '""', polling_frequency: "20", proxy_uri: '""', queue: '""', queue_owner_aws_account_id: '""', region: '"us-east-1"', role_arn: '""', role_session_name: '""', secret_access_key: '""', sent_timestamp_field: '""', session_token: '""', threads: "1", use_aws_bundled_ca: "false", web_identity_token_file: '""' },
    stdin: { ecs_compatibility: '"disabled"' },
    stomp: { destination: '""', host: '"localhost"', password: '""', port: "61613", reconnect: "true", reconnect_interval: "5", user: '""', vhost: '""' },
    syslog: { ecs_compatibility: '"disabled"', facility_labels: '["kernel", "user-level", "mail", "daemon", "security/authorization", "syslogd", "line printer", "network news", "uucp", "clock", "security/authorization", "ftp", "ntp", "log audit", "log alert", "clock", "local0", "local1", "local2", "local3", "local4", "local5", "local6", "local7"]', grok_pattern: '"<%{POSINT:priority}>%{SYSLOGLINE}"', host: '"0.0.0.0"', locale: '""', port: "514", proxy_protocol: "false", severity_labels: '["Emergency", "Alert", "Critical", "Error", "Warning", "Notice", "Debug"]', syslog_field: '"message"', timezone: '""', use_labels: "true" },
    tcp: { dns_reverse_lookup_enabled: "true", ecs_compatibility: '"disabled"', host: '"0.0.0.0"', mode: '"server"', port: "5000", proxy_protocol: "false", ssl_certificate: '""', ssl_certificate_authorities: "[]", ssl_cipher_suites: "[]", ssl_client_authentication: '"none"', ssl_enabled: "false", ssl_extra_chain_certs: "[]", ssl_key: '""', ssl_key_passphrase: '""', ssl_supported_protocols: "[]", ssl_verification_mode: '"full"', tcp_keep_alive: "true" },
    twitter: { consumer_key: '""', consumer_secret: '""', ecs_compatibility: '"disabled"', follows: "[]", full_tweet: "false", ignore_retweets: "false", keywords: "[]", languages: "[]", locations: "[]", oauth_token: '""', oauth_token_secret: '""', proxy_address: '""', proxy_port: "8080", rate_limit_reset_in: "300", target: '""', use_proxy: "false", use_samples: "false" },
    udp: { buffer_size: "65536", ecs_compatibility: '"disabled"', host: '"0.0.0.0"', port: "5000", queue_size: "2000", receive_buffer_bytes: "65536", source_ip_fieldname: '""', workers: "2" },
    unix: { data_timeout: "-1", ecs_compatibility: '"disabled"', force_unlink: "false", mode: '"server"', path: '""', socket_not_present_retry_interval_seconds: "5" },
    varnishlog: { threads: "1" },
    websocket: { mode: '"client"', url: '""' },
...
const LIBRARY_ITEMS = [
  {
    ...
    label: "Inputs",
    items: [
      "azure_event_hubs", "beats", "cloudwatch", "couchdb_changes", "dead_letter_queue", "elastic_agent", "elastic_serverless_forwarder", "elasticsearch", "exec", "file", "ganglia", "gelf", "generator", "github", "google_cloud_storage", "google_pubsub", "graphite", "heartbeat", "http", "http_poller", "imap", "irc", "java_generator", "java_stdin", "jdbc", "jms", "jmx", "kafka", "kinesis", "log4j", "logstash", "lumberjack", "meetup", "pipe", "puppet_facter", "rabbitmq", "redis", "relp", "rss", "s3", "s3-sns-sqs", "salesforce", "snmp", "snmptrap", "sqlite", "sqs", "stdin", "stomp", "syslog", "tcp", "twitter", "udp", "unix", "varnishlog", "websocket", "wmi", "xmpp",
    ],
  },
  {
    category: "filter",
    label: "Filters",
    items: [
      "age", "aggregate", "alter", "bytes", "cidr", "cipher", "clone", "csv", "date", "de_dot", "dissect", "dns", "drop", "elapsed", "elasticsearch", "elastic_integration", "environment", "extractnumbers", "fingerprint", "geoip", "grok", "http", "i18n", "java_uuid", "jdbc_static", "jdbc_streaming", "json", "json_encode", "kv", "memcached", "metricize", "metrics", "mutate", "prune", "range", "ruby", "sleep", "split", "syslog_pri", "threats_classifier", "throttle", "tld", "translate", "truncate", "urldecode", "useragent", "uuid", "wurfl_device_detection", "xml",
    ],
  },
  {
    category: "output",
    label: "Outputs",
    items: [
      "boundary", "circonus", "cloudwatch", "csv", "datadog", "datadog_metrics", "dynatrace", "elastic_app_search", "elastic_workplace_search", "elasticsearch", "email", "exec", "file", "ganglia", "gelf", "google_bigquery", "google_cloud_storage", "google_pubsub", "graphite", "graphtastic", "http", "influxdb", "irc", "java_stdout", "juggernaut", "kafka", "librato", "logstash", "loggly", "lumberjack", "metriccatcher", "mongodb", "nagios", "nagios_nsca", "opentsdb", "pagerduty", "pipe", "rabbitmq", "redis", "redmine", "riak", "riemann", "s3", "sink", "sns", "solr_http", "sqs", "statsd", "stdout", "stomp", "syslog", "tcp", "timber", "udp", "webhdfs", "websocket", "xmpp", "zabbix",
    ],
  },
