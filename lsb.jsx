                  ...
                  <div className="space-y-1 pl-2 border-l border-slate-800 ml-2">
                    {cat.items.map(item => (
                      <div 
                        ...
                        className="flex items-center gap-2 px-3 py-2 bg-slate-800/50 hover:bg-slate-700 rounded cursor-grab active:cursor-grabbing text-sm border border-transparent hover:border-slate-600 transition-all"
                      >
